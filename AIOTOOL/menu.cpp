...
void cMenu::DrawMenu()
{
	...
	if (ImGui::Begin("VIP AIO", &g_vars->msettings.b_menuEnable, ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoScrollWithMouse))
	{
