...
bool ImGui::Checkbox(const char* label, bool* v)
{
	...
	if (*v)
	{
		window->DrawList->AddRectFilled(ImVec2(check_bb.Min.x + pad, check_bb.Min.y + pad), ImVec2(check_bb.Max.x - pad, check_bb.Max.y - pad), ImColor(109, 162, 247, int(t * 205)), 2);
	...
	if (label_size.x > 0.0f)
		window->DrawList->AddText(check_bb.Min + ImVec2(pad, pad) + ImVec2(18, 0), *v ? ImColor(250, 250, 250, 220) : ImColor(255,255,255, 205), label);
